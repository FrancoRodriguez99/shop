...
const producto = [
  ...
  },
  {
    ...
    img: [image3],
    tags: "vehiculos,nuevo,0km,rojo,4puertas,auto",
    precio: [3500000],
    tamanio: ["one"],
    cantidad: [15],
  ...
  },
  {
    ...
    img: [banana],
    tags: "banana,fruta,amarillo,verduleria,cascara",
    precio: [100, 150, 190, 250, 300],
  ...
  },
  {
    ...
    img: [alarma],
    tags: "despertador,reloj,alarma,colores",
    precio: [2500],
    tamanio: ["one"],
    cantidad: [15],
    categorias: ["Vehiculos", "Nuevo", "Auto", "4 Puertas", "Afla Romeo"],
  ...
  },
  {
    ...
    img: [book],
    tags: "libro,book,english,guia,js,javascript",
    precio: [15000],
    tamanio: ["one"],
    cantidad: [15],
    categorias: ["Vehiculos", "Nuevo", "Auto", "4 Puertas", "Afla Romeo"],
  ...
  },
  {
    ...
    img: [bowl],
    tags: "blanco,colores,azul,negro,rojo",
    precio: [1500],
  ...
  },
  {
    ...
    img: [papelhigienico],
    tags: "papel,doble hoja,0km,rojo,4puertas",
    precio: [350],
    tamanio: ["one"],
    cantidad: [15],
    categorias: ["Vehiculos", "Nuevo", "Auto", "4 Puertas", "Afla Romeo"],
  ...
  },
  {
    ...
    img: [shirt],
    tags: "ropa,camisa,camiseta,formal",
    precio: [2500],
    tamanio: ["S", "M", "L", "XL"],
    cantidad: [3, 2, 0, 1],
    categorias: ["Vehiculos", "Nuevo", "Auto", "4 Puertas", "Afla Romeo"],
